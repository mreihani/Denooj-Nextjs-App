...
const EconomyProduct = () => {
    ...
    const [economyProduct, setEconomyProduct] = useState<Product[]>([]);

    useEffect(() => {
        const fetchEconomyProductData = async () => {
            const economyProduct = await getTaggedProduct('economyProduct');
            setEconomyProduct(economyProduct);
        };
        fetchEconomyProductData();
    }, []);
            ...
            <div className="product_scroll">
                <div className="container">
                    <div className="scroll_header">
                        ...
                        <span className="scroll_header_title">محصولات اقتصادی</span>
                    ...
                    <div className="scroll_holder">
                        <div className="scroll_scroller" style={{width: 'calc(145px * 10);'}}>
                            ...
                            {economyProduct && economyProduct.map(product => (
