...
const PopularProduct = () => {
    ...
    useEffect(() => {
        const fetchPopularProductData = async () => {
            const popularProduct = await getTaggedProduct('popularProduct');
            ...
            <div className="product_scroll">
                <div className="container">
                    <div className="scroll_header">
                        ...
                        <span className="scroll_header_title">محصولات پر طرفدار</span>
